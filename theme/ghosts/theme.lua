...
theme.wallpaper = gfs.get_configuration_dir() .. "images/bg.jpg"
...
-- almost pitch black
theme.xbackground = xrdb.background or "#000007"
-- very dark navy blue
theme.xforeground = xrdb.foreground or "#00023f"
--white-ish
theme.xcolor0 = xrdb.color0 or "#f0f0f0"
--light grey
theme.xcolor1 = xrdb.color1 or "#bbbbbb"
-- mid-dark grey / anthracit
theme.xcolor2 = xrdb.color2 or "#4b4b4b"
-- medium navy blue
theme.xcolor3 = xrdb.color3 or "#312660"
-- matt grass-green
theme.xcolor4 = xrdb.color4 or "#4a9234"
-- dark forest-green
theme.xcolor5 = xrdb.color5 or "#29511d"
-- light navy blue
theme.xcolor6 = xrdb.color6 or "#344a92"
-- matt burgunder rot
theme.xcolor7 = xrdb.color7 or "#511d29"
-- dark navy blue
theme.xcolor8 = xrdb.color8 or "#1d2951"
-- mid-purple
theme.xcolor9 = xrdb.color9 or "#48006c"
-- dark purple
theme.xcolor10 = xrdb.color10 or "#340054"
-- pure navy-blue
theme.xcolor11 = xrdb.color11 or "#000754"
-- black-blue-ish
theme.xcolor12 = xrdb.color12 or "#00023f"
...
-- Background Colors
--
theme.bg_dark = theme.xcolor12
theme.bg_normal = theme.xbackground
theme.bg_focus = theme.xcolo12
theme.bg_urgent = theme.xcolor7
theme.bg_minimize = theme.xcolor7

-- Foreground Colors
--
theme.fg_normal = theme.xcolor12
theme.fg_focus = theme.xcolor2
theme.fg_urgent = theme.xcolor1
theme.fg_minimize = theme.xcolor1

theme.button_close = theme.xcolor0

-- Borders
--
theme.border_width = dpi(0)
theme.oof_border_width = dpi(0)
theme.border_normal = theme.xcolor1
theme.border_focus = theme.xcolor0
theme.border_radius = dpi(12)
theme.client_radius = dpi(12)
theme.widget_border_width = dpi(0)
theme.widget_border_color = theme.xcolor2
...
theme.titlebar_fg_focus = theme.xcolor2 .. "55"
...
theme.tooltip_border_color = theme.xcolor2
...
theme.menu_border_color = theme.xcolor2
...
theme.tabbar_fg_normal = theme.xcolor12 .. "55"
...
-- Weather
--
theme.weather_city = "Stuttgart"

-- Swallowing
--
theme.dont_swallow_classname_list = {
    "firefox", "gimp", "dolphin"
}

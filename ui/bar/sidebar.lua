...
local secondtextbox = wibox.widget.textclock("%S")
secondtextbox.markup = helpers.colorize_text(secondtextbox.text, beautiful.xcolor4)
secondtextbox.align = "center"
secondtextbox.valign = "center"
...
local clockbox = wibox.widget {
    {
        {hourtextbox, minutetextbox, secondtextbox, layout = wibox.layout.fixed.vertical},
        top = 5,
        bottom = 5,
        widget = wibox.container.margin
    },
